...
JSON_FILE_PATH = r"C:\AIC2026\jsonupload\embeddings_output.json"  # Đường dẫn tới file JSON chứa embedding TraKE

def main():
    print("⏳ Đang kết nối Qdrant...")
    client = QdrantClient(url=QDRANT_URL)

    vector_size = 768  # TraKE có embedding 512 chiều (dựa theo ảnh 1)
